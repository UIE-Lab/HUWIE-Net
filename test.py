...
def main():
    ...
    parser.add_argument('--model', type=object, default=HUWIE_Net_PIM)
    ...
    model.load_state_dict(torch.load('/home/ozand/DoktoraTez/Data/checkpoints/kayitlar/J1_test_sonuclari/Test143_HUWIE_Net_PIM_20240903_073059/HUWIE_Net_PIM_epoch50.pth'))
    model.to(device)
